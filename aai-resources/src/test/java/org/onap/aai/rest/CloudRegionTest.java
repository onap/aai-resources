...
public class CloudRegionTest extends AbstractSpringRestTest {
    ...
    public void testCloudRegionWithChildAndDoGetAndExpectChildProperties() throws IOException {
        ...
        responseEntity = restTemplate.exchange(baseUrl + endpoint + "/esr-system-info-list", HttpMethod.GET, httpEntity, String.class);
        assertEquals(HttpStatus.OK, responseEntity.getStatusCode());
        assertThat(responseEntity.getBody().toString(), containsString("esr-system-info-id"));
    }
}
